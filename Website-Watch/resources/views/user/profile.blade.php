                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">Họ và tên <span
                                ...
                                id="name-Profile" placeholder="họ và tên" value="{{ Auth::user()->name }}"></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Số điện thoại <span
                                    style="color: red">*</span></label><input type="text" class="form-control"
                                id="phone-Profile" placeholder="nhập số điện thoại"
                                value="{{ Auth::user()->phone_number }}"></div>
                        <div class="col-md-12"><label class="labels">Địa chỉ</label><input type="text"
                                class="form-control" id="address-Profile" placeholder="nhập địa chỉ"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Mật khẩu hiện tại <span
                                ...
                                placeholder="nhập mật khẩu hiện tại" id="pass-Profile" value=""><span
                                onclick="show_hidden_password_profile()" class="changePasword_Profile"><i id="iconProfile"
                                    class="fas fa-eye"></i></span></div>
                        <div class="col-md-6"><label class="labels">Mật khẩu mới</label><input type="password"
                                class="form-control" id="checkPass-Profile" value=""
                                placeholder="nhập mật khẩu cần đổi (nếu cần)"><span
                                onclick="confirm_show_hidden_password_profile()" class="changePasword_Profile"><i
                                    id="iconCProfile" class="fas fa-eye"></i></span></div>
                    </div>
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" id="save-profile-button"
                            type="button">Lưu
