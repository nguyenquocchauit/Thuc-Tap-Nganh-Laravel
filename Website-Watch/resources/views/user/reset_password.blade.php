...
<head>
    ...
    <style>
        * {
        ...
        .form_hoa .box_login #reset .row-item .change-pasword-login {
            position: relative;
            left: 94%;
            bottom: 36px;
            cursor: pointer;
    ...
    <div class="form_hoa">
        <div class="box_login">
            <form action="" method="POST" id="reset">
                ...
                <div class="row-item">
                    <input type="hidden" value="{{ request()->email }}" id="email">
                    <input type="hidden" value="{{ request()->token }}" id="token">
                    <button type="button" id="update-password-customer">Cập nhật</button>
